...
Number.prototype.FormatCurrency = function (decimalPrecision) {
    ///<summary>Returns the number as US currency with the given number of decimalPricision to the right.</summary>
    ///<param name="decimalPrecision" type="Number">(Optional) The number of decimals to the right to display.</param>
    ///<returns type="String">Returns a string representation of the number as USD.</returns>
...
String.prototype.FormatAsPhone = function () {
...
String.BindFormat = function (string, object) {
...
String.Format = function (string, values) {
    ...
    ///<param name="values" type="Array">Array of values that coorespndent to each numbered token.</param>
...
ObservableArray.prototype.Replace = function (object1, object2, altProperty) {
    ///<summary>Replaces all instances of object1 with object2.</summary>
    ///<param name="objec1t" type="Object">Object to remove.</param>
    ///<returns type="Array">Returns the instance.</returns>
    return this;
};
...
function OptionArray() {
    ///<summary>A specialized ObservableArray containing only Options.</summary>
    ///<field name="OnChange" type="Event">(Event) Fired when an object is added or removed.</field>
    ///<field name="Updating" type="Boolean">When set to true, events do not fire for any modification.</field>
    ///<field name="Type" type="String">Returns Type.ObservableArray.</field>
    this[0] =
...
OptionArray.prototype.Add = function (listItem) {
    ///<summary>Adds the option to the end of instance.</summary>
    ///<param name="listItem" type="Option">Option to add to the instance.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};

OptionArray.prototype.AddRange = function (array) {
    ///<summary>Adds the Array of options to the end of the instance.</summary>
    ///<param name="array" type="Array">Array of options to add to the end of instance.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};
...
OptionArray.prototype.Clear = function () {
    ///<summary>Removes all objects from the instance.</summary>
    ///<returns type="OptionArray">Returns the isntance.</returns>
    return this;
};

OptionArray.prototype.Contains = function (listItem) {
    ///<summary>Determines if the option is in the instance.</summary>
    ///<param name="object" type="Option">Option to search for.</param>
    ///<returns type="Boolean">Returns true if the option is found in the instance.</returns>
    return true;
};

OptionArray.prototype.Copy = function () {
    ///<summary>Creates a copy of the instance.</summary>
    ///<returns type="Array">Returns a copy of the instance as a new OptionArray.</returns>
    return new OptionArray();
};

OptionArray.prototype.Insert = function (index, listItem) {
    ///<summary>Inserts the option into the instance at the given index.</summary>
    ///<param name="index" type="Number">Index to insert object at.</param>
    ///<param name="listItem" type="Option">Option to insert.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};
...
OptionArray.prototype.Find = function (func) {
    ...
    ///<param name="func" type="Function">A function accepting two arguments: a option in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="Option">Returns the first option for which func returns true for. If func never returns true, null is returned.</returns>
    return new Option();
};

OptionArray.prototype.FindAll = function (func) {
    ///<summary>Finds the all options that return true for the function provided. Function is given each option as the first parameter.</summary>
    ///<param name="func" type="Function">A function accepting two arguments: a option in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="Array">Returns an Array with all all options for which func returns true for. If func never returns true, an empty Array is returned.</returns>
    var c = new Option();
    return [c, c, c, c, c];
};
...
OptionArray.prototype.ForEach = function (func) {
    ///<summary>Calls the function giving each option as the first parameter to the function.</summary>
    ///<param name="func" type="Function">Function taking the option as the first parameter.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};
...
OptionArray.prototype.IndexOf = function (listItem) {
    ///<summary>Returns the index of the first occurrence of the option in the instance.</summary>
    ///<param name="listItem" type="Option">Option to check for.</param>
    ///<returns type="Number">Returns the index of the first occurance of the listItem. If the option was not found, returns -1.</returns>
    return this;
};

OptionArray.prototype.Move = function (listItem, index) {
    ///<summary>Moves the option to the given index of the instance, shifting other options to the left.</summary>
    ///<param name="listItem" type="Option">Option to move.</param>
    ///<param name="index" type="Number">Index to move the option to.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};

OptionArray.prototype.Remove = function (listItem) {
    ///<summary>Removes the all occurences of the option from the instance.</summary>
    ///<param name="listItem" type="Option">Option to remove.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};

OptionArray.prototype.RemoveAt = function (index) {
    ///<summary>Removes the option from the instance at the given index.</summary>
...
OptionArray.prototype.RemoveRange = function (array) {
    ///<summary>Removes the Array of options from the instance.</summary>
    ///<param name="array" type="Array">An Array of options to be removed from the instance.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};

OptionArray.prototype.Swap = function (listItem1, listItem2) {
    ///<summary>Swaps the positions of the two options in the instance.</summary>
    ///<param name="listItem1" type="Option">First option to swap.</param>
    ///<param name="listItem2" type="Option">Second option to swap.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};

OptionArray.prototype.ShiftLeft = function (index) {
    ///<summary>Shifts the indexed option to the left in the instance.</summary>
    ///<param name="index" type="Number">Index to move.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};
...
OptionArray.prototype.ShiftRight = function (index) {
    ///<summary>Shifts the indexed option to the right in the instance.</summary>
    ///<param name="index" type="Number">Index to move.</param>
    ///<returns type="OptionArray">Returns the instance.</returns>
    return this;
};
...
OptionArray.prototype.ToString = function (delimiter) {
    ///<summary>Returns a string version of each option in the instance.</summary>
    ///<param name="delimiter" type="String" optional="true" default=",">The string to use to separate option string versions.</param>
    ///<returns type="String">Returns a string with each option string representation divided by the delimiter.</returns>
    return "";
};

function RadioButtonGroup() {
    ///<summary>A specialized ObservableArray containing only radio buttons in a group.</summary>
    ///<field name="OnChange" type="Event">(Event) Fired when an object is added or removed.</field>
    ///<field name="Updating" type="Boolean">When set to true, events do not fire for any modification.</field>
    ///<field name="Type" type="String">Returns Type.ObservableArray.</field>
    this[0] =
...
RadioButtonGroup.prototype.Clear = function () {
    ...
    ///<returns type="RadioButtonGroup">Return the instance,.
    return this;
};

RadioButtonGroup.prototype.SelectedValue = function (value) {
    ///<summary>(Property Function) Gets or sets the value of the selected radio button in the group.</summary>
    ///<param name="value" type="String" >(Optional) The value of the radio button to be selectd.</param>
    if (value === undefined) { return this.Type === Type.Array ? [] : ""; }
    return this;
};

RadioButtonGroup.prototype.Add = function (radioButton) {
    ///<summary>Adds the radio button to the end of radio button group.</summary>
    ///<param name="radioButton" type="RadioButton">RadioButton to add to the instance.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};

RadioButtonGroup.prototype.AddRange = function (array) {
    ///<summary>Adds the Array of radio buttons to the radio button group.</summary>
    ///<param name="array" type="Array">Array of options to add to the end of instance.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};

RadioButtonGroup.prototype.Contains = function (radioButton) {
    ///<summary>Determines if the radio button is in the radio button group.</summary>
    ///<param name="object" type="RadioButton">RadioButton to search for.</param>
    ///<returns type="Boolean">Returns true if the radio button is found in the instance.</returns>
    return true;
};


RadioButtonGroup.prototype.Find = function (func) {
    ///<summary>Finds the first radio button that returns true for the function provided. Function is given each radio button as the first parameter.</summary>
    ///<param name="func" type="Function">A function accepting two arguments: a radio button in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="RadioButton">Returns the first radio button for which func returns true for. If func never returns true, null is returned.</returns>
    return new RadioButton();
};

RadioButtonGroup.prototype.FindAll = function (func) {
    ///<summary>Finds the all radio buttons that return true for the function provided. Function is given each radio button as the first parameter.</summary>
    ///<param name="func" type="Function">A function accepting two arguments: a radio button in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="Array">Returns an Array with all all radio buttons for which func returns true for. If func never returns true, an empty Array is returned.</returns>
...
RadioButtonGroup.prototype.ForEach = function (func) {
    ///<summary>Calls the function giving each radio button as the first parameter to the function.</summary>
    ///<param name="func" type="Function">Function taking the radio button as the first parameter.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};
...
RadioButtonGroup.prototype.ForEachReversed = function (func) {
    ///<summary>Calls the function giving each radio button, in reverse order, as the first parameter to the function.</summary>
    ///<param name="func" type="Function">Function taking the radio button as the first parameter.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};
...
RadioButtonGroup.prototype.Remove = function (radioButton) {
    ///<summary>Removes the all occurences of the radio button from the instance.</summary>
    ///<param name="radioButton" type="RadioButton">RadioButton to remove.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};

RadioButtonGroup.prototype.RemoveRange = function (array) {
    ///<summary>Removes the Array of radio buttons from the group.</summary>
    ///<param name="array" type="Array">An Array of radio buttons to be removed from the group.</param>
    ///<returns type="RadioButtonGroup">Returns the instance.</returns>
    return this;
};
...
function RowArray() {
    ///<summary>A specialized ObservableArray containing only Rows.</summary>
    ///<field name="OnChange" type="Event">(Event) Fired when an object is added or removed.</field>
    ///<field name="Updating" type="Boolean">When set to true, events do not fire for any modification.</field>
    ///<field name="Type" type="String">Returns Type.ObservableArray.</field>
    this[0] =
...
RowArray.prototype.Add = function (listItem) {
    ///<summary>Adds the row to the end of instance.</summary>
    ///<param name="listItem" type="Row">Row to add to the instance.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};

RowArray.prototype.AddRange = function (array) {
    ///<summary>Adds the Array of rows to the end of the instance.</summary>
    ///<param name="array" type="Array">Array of rows to add to the end of instance.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};
...
RowArray.prototype.Clear = function () {
    ///<summary>Removes all objects from the instance.</summary>
    ///<returns type="RowArray">Returns the isntance.</returns>
    return this;
};

RowArray.prototype.Contains = function (listItem) {
    ///<summary>Determines if the row is in the instance.</summary>
    ///<param name="object" type="Row">Row to search for.</param>
    ///<returns type="Boolean">Returns true if the row is found in the instance.</returns>
    return true;
};

RowArray.prototype.Copy = function () {
    ///<summary>Creates a copy of the instance.</summary>
    ///<returns type="Array">Returns a copy of the instance as a new RowArray.</returns>
    return new RowArray();
};

RowArray.prototype.Insert = function (index, listItem) {
    ///<summary>Inserts the row into the instance at the given index.</summary>
    ///<param name="index" type="Number">Index to insert object at.</param>
    ///<param name="listItem" type="Row">Row to insert.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};
...
RowArray.prototype.Find = function (func) {
    ...
    ///<param name="func" type="Function">A function accepting two arguments: a row in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="Row">Returns the first row for which func returns true for. If func never returns true, null is returned.</returns>
    return new Row();
};

RowArray.prototype.FindAll = function (func) {
    ///<summary>Finds the all rows that return true for the function provided. Function is given each row as the first parameter.</summary>
    ///<param name="func" type="Function">A function accepting two arguments: a row in the instance and an IterationEventArgs and returns true or false.</param>
    ///<returns type="Array">Returns an Array with all all rows for which func returns true for. If func never returns true, an empty Array is returned.</returns>
    var c = new Row();
    return [c, c, c, c, c];
};
...
RowArray.prototype.ForEach = function (func) {
    ///<summary>Calls the function giving each row as the first parameter to the function.</summary>
    ///<param name="func" type="Function">Function taking the row as the first parameter.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};
...
RowArray.prototype.IndexOf = function (listItem) {
    ///<summary>Returns the index of the first occurrence of the row in the instance.</summary>
    ///<param name="listItem" type="Row">Row to check for.</param>
    ///<returns type="Number">Returns the index of the first occurance of the listItem. If the row was not found, returns -1.</returns>
    return this;
};

RowArray.prototype.Move = function (listItem, index) {
    ///<summary>Moves the row to the given index of the instance, shifting other rows to the left.</summary>
    ///<param name="listItem" type="Row">Row to move.</param>
    ///<param name="index" type="Number">Index to move the row to.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};

RowArray.prototype.Remove = function (listItem) {
    ///<summary>Removes the all occurences of the row from the instance.</summary>
    ///<param name="listItem" type="Row">Row to remove.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};

RowArray.prototype.RemoveAt = function (index) {
    ///<summary>Removes the row from the instance at the given index.</summary>
...
RowArray.prototype.RemoveRange = function (array) {
    ///<summary>Removes the Array of rows from the instance.</summary>
    ///<param name="array" type="Array">An Array of rows to be removed from the instance.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};

RowArray.prototype.Swap = function (listItem1, listItem2) {
    ///<summary>Swaps the positions of the two rows in the instance.</summary>
    ///<param name="listItem1" type="Row">First row to swap.</param>
    ///<param name="listItem2" type="Row">Second row to swap.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};

RowArray.prototype.ShiftLeft = function (index) {
    ///<summary>Shifts the indexed row to the left in the instance.</summary>
    ///<param name="index" type="Number">Index to move.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};
...
RowArray.prototype.ShiftRight = function (index) {
    ///<summary>Shifts the indexed row to the right in the instance.</summary>
    ///<param name="index" type="Number">Index to move.</param>
    ///<returns type="RowArray">Returns the instance.</returns>
    return this;
};
...
RowArray.prototype.ToString = function (delimiter) {
    ///<summary>Returns a string version of each row in the instance.</summary>
    ///<param name="delimiter" type="String" rowal="true" default=",">The string to use to separate row string versions.</param>
    ///<returns type="String">Returns a string with each row string representation divided by the delimiter.</returns>
    return "";
};
...
RowArray.prototype.BeginUpdate = function () {
    ///<summary>Begins an update to the ObservableArray where events are not thrown during modifications.</summary>
    ///<returns type="ObservableArray">Returns the instance.</
    return this;
};
...
RowArray.prototype.EndUpdate = function () {
    ///<summary>Ends an update to the ObservableArray where the OnUpdate event is fired.</summary<
    ///<returns type="ObservableArray">Returns the instance.</returns>
    return this;
};
...
function Dictionary() {
    ...
    ///<field name="Type" type="String">Returns Type.Dictionary.</field>
}
...
Dictionary.FromObject = function (object) {
    ...
    ///<returns type="Dictionary">Returns the newly created Dictionary.</returns>
    return new Dictionary();
};

Dictionary.FromString = function (string, itemDelimeter, keyValueDelimeter) {
    ...
    ///<param name="keyValueDelimeter" type="String">The string that separates each key value pair in each item.</param>
    ///<returns type="Dictionary">Returns the newly created Dictionary.</returns>
    return new Dictionary();
};
...
Dictionary.prototype.Add = function (key, value) {
    ...
    ///<returns type="Dictionary">Returns the instance.</returns>
    this[key] = value;
    return this;
};
...
Dictionary.prototype.ContainsKey = function (key) {
    ...
    ///<returns type="Boolean">Returns whether the key is found in the instance.</returns>
    return true;
};

Dictionary.prototype.Copy = function () {
    ///<summary>Creates a copy of the dictionary.</summary>
    ///<returns type="Dictionary">Returns a copy of the dictionary.</returns>
    return new Dictionary();
};
...
Dictionary.prototype.ContainsValue = function (value) {
    ...
    ///<returns type="Boolean">Returns whether the value is found in the instance.</returns>
    return true;
};

Dictionary.prototype.Count = function () {
    ///<summary>Determines the number of key value pairs in the dictionary.</summary>
    ///<returns type="Number">Returns the number of key value pairs in the instance.</returns>
    return 0;
};
...
Dictionary.prototype.ForEach = function (_func) {
    ...
    ///function is provided a simple parameter of IterationEventArgs.</summary>
...
Event.prototype.Enabled = function (enabled) {
    ///<summary>(Property Function) Gets or sets the enabled state of the event.</summary>
    ///<param name="enabled" type="Boolean">Enabled state of the event.</param>
    return 0;
};
...
UserEvent.prototype.Enabled = function (enabled) {
    ///<summary>(Property Function) Gets or sets the enabled state of the event.</summary>
    ///<param name="enabled" type="Boolean">Enabled state of the event.</param>
    return 0;
};
...
function IterationEventArgs(obj, index, sender) {
    ...
    ///<field name="Sender" type="Object">The object that sent the event.</field>
    ///<field name="Navigate" type="Number">Used to control looping. Changing this will affect the next iteration. A .FormPostive number means skipping the number of elements. A negative number means going back to already touched elements. After each iteration, Navigate is set back to 0.</field>
    ///<field name="Type" type="String">Returns Type.EventArgs</field>
}
...
function MouseWheelEventArgs(event, sender) {
    ...
    ///<field name="Sender" type="Object">The object that sent the event.</field>
    ///<field name="Type" type="String">Returns Type.EventArgs</field>
    ///<field name="Clicks" type="Number">Number of clicks the wheel was turned. A negative click is a wheel push forward (up), a .FormPostive click is a wheel push back (down).</field>
}
...
function TouchEventArgs(event, sender) {
    ///<summary>Contains generic information about a touch event on mobile devices.</summary>
    ///<param name="sender" type="Object">The object sending the event.</param>
    ///<field name="CancelEvent" type="Boolean">If set to true, no other handlers will be executed.</field>
    ///<field name="Handled" type="Boolean">If set to true, default behavior is prevented on the browser.</field>
    ///<field name="TouchStates" type="Array">An array of ToucheStates.</field>
}

TouchEventArgs.prototype.Handled = false;
TouchEventArgs.prototype.Sender = {};
TouchEventArgs.prototype.RawEvent = {};
TouchEventArgs.prototype.CancelEvent = false;
TouchEventArgs.prototype.EventType = "";
TouchEventArgs.prototype.TouchStates = [new TouchState(), new TouchState(), new TouchState(), new TouchState()];

function TouchState(e) {
    ///<summary>Information regarding various touches from a Touch Event.</summary>
    ///<field name="X" type="Number">X position, relative to the screen, of the touch.</field>
    ///<field name="Y" type="Number">Y position, relative to the screen, of the touch.</field>
}

TouchState.prototype.X = 0;
TouchState.prototype.Y = 0;
...
DateTime.prototype.GetDate = function () {
    ///<summary>Returns the date portion (at midnight) of the DateTime as a new DateTime.</summary>
    return new DateTime();
};
...
var NinJa = (function () {
    ...
    ///<field name="Extensions" type="Dictionary">Extensions.</field>
...
var Client = function () {
    ...
    ///<field name="OnScroll" type="Event">(Event)Fired when the client window is scrolled.</field>
...
function $TouchEventArgs(object) {
    ///<summary>Treats the object as a TouchEventArgs for intellisense.</summary>
    ///<param name="object" type="Object">Object.</param>
    return new TouchEventArgs({}, {});
}

function $TouchState(object) {
    ///<summary>Treats the object as a TouchState for intellisense.</summary>
    ///<param name="object" type="Object">Object.</param>
...
Element.prototype.OnTouchStart = new UserEvent();
Element.prototype.OnTouchEnd = new UserEvent();
Element.prototype.OnTouchMove = new UserEvent();
...
Content.prototype.OnTouchStart = new UserEvent();
Content.prototype.OnTouchEnd = new UserEvent();
Content.prototype.OnTouchMove = new UserEvent();
...
function Input(e) {
    ...
    ///<field name="OnChange" type="UserEvent">&lt;UserEvent&gt;Fired when the input value has changed.</field>
}
...
Input.prototype.OnTouchStart = new UserEvent();
Input.prototype.OnTouchEnd = new UserEvent();
Input.prototype.OnTouchMove = new UserEvent();
...
Anchor.prototype.OnTouchStart = new UserEvent();
Anchor.prototype.OnTouchEnd = new UserEvent();
Anchor.prototype.OnTouchMove = new UserEvent();
...
Body.prototype.OnTouchStart = new UserEvent();
Body.prototype.OnTouchEnd = new UserEvent();
Body.prototype.OnTouchMove = new UserEvent();
...
Body.prototype.Href = function (location) {
    ///<summary>(Property Function)Gets or sets the current page's href location.</summary>
...
Button.prototype.OnTouchStart = new UserEvent();
Button.prototype.OnTouchEnd = new UserEvent();
Button.prototype.OnTouchMove = new UserEvent();
...
Div.prototype.OnTouchStart = new UserEvent();
Div.prototype.OnTouchEnd = new UserEvent();
Div.prototype.OnTouchMove = new UserEvent();
...
Label.prototype.For = function (id) {
    ///<summary>(Property Function)Gets or sets the id of input element in which the label refers to.</summary>
...
Label.prototype.Content = function (content) {
    ///<summary>(Property Function)Gets or sets
};

Label.prototype.Text = function (text) {
    ///<summary>(Property Function)Gets or sets the text of a label.</summary>
    ///<param name="text" type="String">(Optional) If provided, sets the text of the label.</param>
    ///<returns type="String">If text not provided, returns the current text of the label.</returns>
    if (text === undefined) {
        return "";
    }
...
TextBox.prototype.AutoFormat = function (format) {
    /// <summary>(Property Function) Gets or sets the auto formatting policy for this text box.</summary>
    /// <param name="format" type="String">(Optional) Name of the string function to use to format the text.</param>
    /// <returns type="String">The current format.</returns>
...
Anchor.prototype.Attribute =
Body.prototype.Attribute =
Button.prototype.Attribute =
Cell.prototype.Attribute =
CheckBox.prototype.Attribute =
DropDownList.prototype.Attribute =
Content.prototype.Attribute =
ContentButton.prototype.Attribute =
Div.prototype.Attribute =
Element.prototype.Attribute =
FileUpload.prototype.Attribute =
Header.prototype.Attribute =
ImageElement.prototype.Attribute =
Label.prototype.Attribute =
List.prototype.Attribute =
ListBox.prototype.Attribute =
ListItem.prototype.Attribute =
Password.prototype.Attribute =
RadioButton.prototype.Attribute =
Row.prototype.Attribute =
Span.prototype.Attribute =
Table.prototype.Attribute =
TableBody.prototype.Attribute =
TableFoot.prototype.Attribute =
TableHead.prototype.Attribute =
TextArea.prototype.Attribute =
TextBox.prototype.Attribute = function (attribute, value) {
    ///<summary>(Property Function)Gets or sets the specified attribute.</summary>
    ///<param name="attribute" Type="String">The attribute to get or set.</param>
    ///<param name="value" Type="String">The value to set the attribute to.</param>
    if (value === undefined) { return this.Type === Type.Array ? [] : ""; }
    return this;
};
...
Anchor.prototype.BindData =
Body.prototype.BindData =
Cell.prototype.BindData =
CheckBox.prototype.BindData =
DropDownList.prototype.BindData =
Content.prototype.BindData =
ContentButton.prototype.BindData =
Div.prototype.BindData =
ImageElement.prototype.BindData =
Label.prototype.BindData =
List.prototype.BindData =
ListBox.prototype.BindData =
ListItem.prototype.BindData =
Password.prototype.BindData =
RadioButton.prototype.BindData =
Row.prototype.BindData =
Span.prototype.BindData =
Table.prototype.BindData =
TableBody.prototype.BindData =
TableFoot.prototype.BindData =
TableHead.prototype.BindData =
TextArea.prototype.BindData =
TextBox.prototype.BindData = function (object) {
    ///<summary>Binds the object to the element and any child elements, setting a value based on the BindProperty</summary>
    ///<returns>Returns the instance of the calling object.</returns>
    return this;
};

Body.prototype.BuildObjectFromBinding =
Content.prototype.BuildObjectFromBinding = 
Row.prototype.BuildObjectFromBinding = function () {
    ///<summary>Builds an object based on the bindfield attribute with the values of each input.</summary>
    ///<returns type="Object" />
    return {};
};

Anchor.prototype.BindField =
Cell.prototype.BindField =
CheckBox.prototype.BindField =
DropDownList.prototype.BindField =
Content.prototype.BindField =
ContentButton.prototype.BindField =
Div.prototype.BindField =
ImageElement.prototype.BindField =
Label.prototype.BindField =
List.prototype.BindField =
ListBox.prototype.BindField =
ListItem.prototype.BindField =
Password.prototype.BindField =
RadioButton.prototype.BindField =
Row.prototype.BindField =
Span.prototype.BindField =
Table.prototype.BindField =
TableBody.prototype.BindField =
TableFoot.prototype.BindField =
TableHead.prototype.BindField =
TextArea.prototype.BindField =
TextBox.prototype.BindField = function (property) {
    ///<summary>(Property Function)Gets or sets the bind property.</summary>
    ///<param name="property" Type="String">(Optional)Name of the property to use when binding an object.</param>
...
DropDownList.prototype.Name =
ContentButton.prototype.Name =
FileUpload.prototype.Name =
Input.prototype.Name =
Password.prototype.Name =
RadioButton.prototype.Name =
TextArea.prototype.Name =
TextBox.prototype.Name = function (name) {
    ///<summary>(Property Function)Gets or sets the name of the element.</summary>
    ///<param name="name" type="String">(Optional)The name of the element.</param>
    if (name === undefined) { return this.Type === Type.Array ? [] : true; }
    return this;
};
...
Button.prototype.ReadOnly =
CheckBox.prototype.ReadOnly =
DropDownList.prototype.ReadOnly =
ContentButton.prototype.ReadOnly =
FileUpload.prototype.ReadOnly =
Input.prototype.ReadOnly =
Password.prototype.ReadOnly =
RadioButton.prototype.ReadOnly =
TextBox.prototype.ReadOnly =
TextArea.prototype.ReadOnly = function (readOnly) {
    ///<summary>(Property Function)Gets or sets the read only state of the element.</summary>
    ///<param name="enabled" type="Boolean">(Optional)Whether the input element is read only.</param>
    if (readOnly === undefined) { return this.Type === Type.Array ? [] : true; }
    return this;
};
...
Anchor.prototype.IndexOfElement =
Body.prototype.IndexOfElement =
Cell.prototype.IndexOfElement =
Content.prototype.IndexOfElement =
ContentButton.prototype.IndexOfElement =
Div.prototype.IndexOfElement =
ListItem.prototype.IndexOfElement =
Span.prototype.IndexOfElement = function (element) {
    ///<summary>Returns the index of the element in the DOM tree.</summary>
    ///<field name="elemenet" type="Element">The child element.</field>
    ///<returns type="Number">The index of the element. If the element is not found in the first level of the parent, -1 is returned.</returns>
    return 0;
};
...
ContentButton.prototype.ID =
Div.prototype.ID =
Element.prototype.ID =
FileUpload.prototype.ID =
Header.prototype.ID =
ImageElement.prototype.ID =
Label.prototype.ID =
List.prototype.ID =
ListBox.prototype.ID =
...
Span.prototype.ID =
Table.prototype.ID =
TableBody.prototype.ID =
TableFoot.prototype.ID =
TableHead.prototype.ID =
TextArea.prototype.ID =
TextBox.prototype.ID = function (id) {
    ///<summary>(Property Function)Gets or sets whether the id of the element.</summary>
    ///<param name="italic" type="Boolean">(Optional) The id of the element.</param>
    if (id === undefined) { return this.Type === Type.Array ? [] : true; }
    return this;
};
...
TextBox.prototype.Opacity = function (opacity) {
    ...
    ///<returns type="Number">The opacity level of the element.</returns>
    if (opacity === undefined) { return this.Type === Type.Array ? [] : 0; }
    return this;
};

Anchor.prototype.Parent =
Button.prototype.Parent =
CheckBox.prototype.Parent =
DropDownList.prototype.Parent =
Content.prototype.Parent =
ContentButton.prototype.Parent =
Div.prototype.Parent =
Element.prototype.Parent =
FileUpload.prototype.Parent =
ImageElement.prototype.Parent =
Label.prototype.Parent =
List.prototype.Parent =
ListBox.prototype.Parent =
Password.prototype.Parent =
RadioButton.prototype.Parent =
Span.prototype.Parent =
Table.prototype.Parent =
TextArea.prototype.Parent =
TextBox.prototype.Parent = function () {
    ///<summary>Gets the parent of the element.</summary>
    ///<returns type="Content">The parent of the element.</returns>
    return this.Type === Type.Array ? [] : new Content();
};
TableBody.prototype.Parent =
TableFoot.prototype.Parent =
TableHead.prototype.Parent = function () {
    ///<summary>Gets the parent of the element.</summary>
    ///<returns type="Element">The parent of the element.</returns>
    return this.Type === Type.Array ? [] : new Table();
};

Row.prototype.Parent = function () {
    ///<summary>Gets the parent of the element.</summary>
    ///<returns type="Element">The parent of the element.</returns>
    return this.Type === Type.Array ? [] : new TableBody();
};

ListItem.prototype.Parent = function () {
    ///<summary>Gets the parent of the element.</summary>
    ///<returns type="Element">The parent of the element.</returns>
    return this.Type === Type.Array ? [] : new List();
};

Cell.prototype.Parent =
Header.prototype.Parent = function () {
    ///<summary>Gets the parent of the element.</summary>
    ///<returns type="Element">The parent of the element.</returns>
    return this.Type === Type.Array ? [] : new Row();
};
...
Anchor.prototype.RemoveElement =
Body.prototype.RemoveElement =
Cell.prototype.RemoveElement =
Content.prototype.RemoveElement =
ContentButton.prototype.RemoveElement =
Div.prototype.RemoveElement =
ListItem.prototype.RemoveElement =
Span.prototype.RemoveElement = function (element) {
    ///<summary>Removes the child element from the parent.</summary>
    ///<param name="element" type="Element">Element to remove.</param>
    return this;
};

Anchor.prototype.RemoveElementAt =
Body.prototype.RemoveElementAt =
Cell.prototype.RemoveElementAt =
Content.prototype.RemoveElementAt =
ContentButton.prototype.RemoveElementAt =
Div.prototype.RemoveElementAt =
ListItem.prototype.RemoveElementAt =
Span.prototype.RemoveElementAt = function (index) {
    ///<summary>Removes the child element at the given index from the parent.</summary>
    ///<param name="index" type="Number">Index of the element to remove.</param>
    return {};
};

Anchor.prototype.RemoveElements =
Body.prototype.RemoveElements =
Cell.prototype.RemoveElements =
Content.prototype.RemoveElements =
ContentButton.prototype.RemoveElements =
Div.prototype.RemoveElements =
ListItem.prototype.RemoveElements =
Span.prototype.RemoveElements = function (elements) {
...
function ConvertObjectToJSON() {
    ///<summary>Serializes the object in the JSON format.</summary>
    ///<returns type="String">JSON serialization of the object.</returns>
    return "";
}

String.prototype.ToObjectFromJSON = function () {
    ///<summary>Deserializes the string into an object from the JSON format. Auotmatically handles Microsoft date formats.</summary>
