...
var Type = function (object) {
    ...
    object.DropDownList = object.$++;
    object.ContentButton = object.$++;
    object.Date = object.$++;
    ...
    object.FauxEvent = object.$++;
    object.FileUpload = object.$++;
    object.Form = object.$++;
    object.Function = object.$++;
    object.Header = object.$++;
    object.HiddenField = object.$++;
    object.Image = object.$++;
    object.Label = object.$++;
    object.ListBox = object.$++;
    object.List = object.$++;
    ...
    object.RadioButtonGroup = object.$++;
    object.Row = object.$++;
    object.Password = object.$++;
    object.Span = object.$++;
    object.String = object.$++;
    object.Table = object.$++;
    object.TableBody = object.$++;
    object.TableHead = object.$++;
    object.TableFoot = object.$++;
    object.TextArea = object.$++;
    object.TextBox = object.$++;
    object.TimeSpan = object.$++;
    object.Timer = object.$++;
    object.UserEvent = object.$++;
    object.Window = object.$++;

    object.NewType = function (name) {
        this[name] = this.$++;
    };
    return object;
}({});
...
Array.prototype.RemoveRange = function (r) {
    ...
    if (this.$ == true) {
        if (!this.Updating && this.OnChange.length > 0) {
            this.OnChange.Fire(new ArrayEventArgs(r, ModificationType.Remove, -1, this));
        }
    }
    return this;
};
...
DateTime.prototype.GetTime = function () {
    var h = this.Hour();
    h = h == 0 ? 12 : h;
    return new Time(h > 12 ? h - 12 : h, this.Minute(), this.Second(), this.Hour() >= 12 ? Period.PM : Period.AM);
}
...
Time.prototype.ToString = function () {
    return this.Hour + ":" + this.Minute.toString().PadLeft(2, "0") + ":" + this.Second.toString().PadLeft(2, "0") + " " + (this.Period === 0 ? "AM" : "PM");
}
//#endregion
...
function Element(e, t) {
    ...
    var s = e.getAttribute("show");
    if (!NullOrUndefined(s)) {
        if (s.length > 0) {
            this.Collapsed(!s.ToBoolean());
        }

        e.setAttribute("refreshrequired", "true");
    }
}
...
Element.prototype.RefreshChildren = function () {
...
Element.prototype.RefreshDisplay = function () {
    var s = this.DOM.getAttribute("show");
    if (!NullOrUndefined(s)) {
        if (s.length > 0) {
            this.Collapsed(!s.ToBoolean());
        }
...
Element.prototype.Parent = function () {
    ...
    if (!NullOrUndefined(p) && p.tagName !== undefined) {
        if (p.$ === undefined) {
            Content.New(p);
        }
        return p.$;
...
Body.prototype.__hm = function (event) {
    ...
    if (document.documentElement.scrollLeft !== undefined && document.documentElement.scrollTop !== undefined) {
...
FileUpload.RefreshAccepts = function () {
    var first = true, f = Event.Current.Sender, e = f.DOM, a = f.Accepts, l = f.Accepts.length, v, i;
...
HiddenField.prototype.Enabled = function () {
    return true;
}
...
Label.prototype.Text = function (e) {
    if (e === undefined) {
        if (this.DOM.textContent !== undefined) {
...
function TextBox(e) {
    ...
    $.OnFocus.Add($.__De);
    $.__Af = (e.getAttribute("format") || null);
...
TextBox.prototype.AutoFormat = function (a) {
    ...
    this.__Af = a;
    this.__De.Enabled = this.__Ad.Enabled = a !== null;
    return this;
};
...
var NinJa = function (o) {
    ...
    o.EvalBind = function (p, j, t) {
        ...
        for (i = 0; i < l; i++) {
            ...
            if (v.StartsWith("@")) {
                ...
                if (!NullOrUndefined(j[v])) {
                    if (j[v].Type == Type.Function && t === false) {
                        j = j[v]();
                    }
                    else {
                        j = j[v];
        ...
        if (j !== undefined && j.Type == Type.DateTime && j.Equals(DateTime.Null)) {
            j = "";
        }
        return j;
    };
    ...
    o.Preprocess = function (e) {
        ...
        c = Array.From(e.querySelectorAll("." + NinJa.Extensions.Keys().ToString(" ,.")));
        l = c.length;
        for (i = 0; i < l; i++) {
            u = c[i].$;
            a = u.Classes;
            k = a.length;
            for (j = 0; j < k; j++) {
                v = NinJa.Extensions[a[j]];
                if (v !== undefined) {
                    v.Inherit(v.Extend(u));
                }
            }
        }
    }
    ...
    window.$TextBox = function (x) {
        ...
        if (x.Type !== undefined && x.Type !== Type.String) {
            return x;
        }
...
var Client = function ($c) {
    ...
    var resizeTimer = new Timer(200, false);
    resizeTimer.OnTrigger.Add(fireResize);
    ...
    for (var n in o) {
        ...
        if (!NullOrUndefined(v)) {
            if (v.Type == Type.Array || v.Type == undefined) {
                ...
                if (a) {
                    o[n] = new DateTime(parseInt(a[1], 10)).Subtract(new TimeSpan(0, DateTime.TimezoneOffset() - DateTime.ServerTimezoneOffset));
                }
            }
        }
    }
...
window.onerror = NinJa.DefaultExceptionHandler;
window.Page = {};
