...
Array.prototype.As = function (type) {
    ///<summary>Allows you to treat the entire instance as a simple object, calling a function for each item in the array.</summary>
...
QueryClause.prototype.SelectFirst = function (property) {
    ///<summary>Calls the query, selecting the first object that meets the requirements provided to the query claue.</summary>
    ///<param name="property" type="String">(Optional) A specific field or property function to return as the array set, otherwise the entire object is returned.</param>
    return {};
};
...
Array.prototype.FindNearest = function (value) {
	///<summary>Searches the the array for the closest to the value mathematically and returns that item.</summary>
	return 0;
};
...
Array.prototype.Flatten = function () {
    ///<summary>Flattens an array of arrays into a simple array.</summary>
    return [];
};
...
Array.prototype.Group = function (property) {
	...
	///<returns type="Dictionary">Returns the resulting dictionary.</returns>
...
Array.prototype.Subset = function (startIndex, length) {
    ///<summary>Returns a subset of the array from the startIndex.</summary>
    ///<param name="startIndex" type="Number">Start index to begin the subset.</param>
    ///<param name="length" isOptional="true">(Optional)If provided, the number of elements to return. If not provided, all elements from startIndex are returned.</param>
