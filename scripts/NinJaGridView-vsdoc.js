...
function GridViewColumn(id) {
	...
	///<field name="OnColumnBound" type="Event">(Event) Fires when a specific column on a row is bound.</field>
	///<field name="OnItemClick" type="Event">(Event) Fires when an item is clicked in this column.</field>
}

GridViewColumn.prototype.OnColumnBound = new Event();
GridViewColumn.prototype.OnItemClick = new Event();
...
function ColumnBoundEventArgs(sender, column, item) {
	///<summary>Represents properties for a event when a column is bound to.</summary>
	///<param name="sender" type="GridView">The sender of the event.</param>
	///<param name="column" type="GridViewColumn">The GridViewColumn being beind to.</param>
	///<param name="item" type="Object">Object being bound to the GridViewColumn.</param>
	///<field name="Sender" type="GridView">The sender of the event.</field>
	///<field name="Column" type="GridViewColumn">The GridViewColumn being beind to.</field>
	///<field name="Item" type="Object">Object being bound to the GridViewColumn.</field>
	///<field name="Cancel" type="Boolean">If set to true, prevents the column from being bound to.</field>
}

function $ColumnBoundEventArgs(object) {
	///<summary>Treats the object as a RowBoundEventArgs type.</summary>
	return new ColumnBoundEventArgs();
}

ColumnBoundEventArgs.prototype.Sender = new GridView();
ColumnBoundEventArgs.prototype.Column = new GridViewColumn();
ColumnBoundEventArgs.prototype.Item = {};
ColumnBoundEventArgs.prototype.Cancel = false;